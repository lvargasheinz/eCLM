...
contains
 ...
 !    call oasis_put(oas_id_drag, seconds_elapsed,lnd2atm_inst%t_sf_grc, info)          ! "CLM_DRAG"
  ...
  !   call oasis_put(oas_id_wt, seconds_elapsed,lnd2atm_inst%vdustfrac_grc, info)          ! "CLM_WT"
   !  call oasis_put(oas_id_zo, seconds_elapsed,lnd2atm_inst%zom_grc, info)          ! "CLM_ZO"
!     call oasis_put(oas_id_tlef, seconds_elapsed,lnd2atm_inst%t_lef_grc, info)          ! "CLM_TLEF"
