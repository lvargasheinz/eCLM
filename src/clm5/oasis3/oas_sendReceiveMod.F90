module oas_sendReceiveMod
  ...
  public  :: oas_send_regcm
  public  :: oas_receive_regcm
#endif
contains
...
#ifdef COUP_OAS_REGCM
  subroutine oas_receive_regcm(bounds, seconds_elapsed, x2l)
    use atm2lndType, only: atm2lnd_type
    use clm_cpl_indices
  ...
  end subroutine oas_receive_regcm

  subroutine oas_send_regcm(bounds, seconds_elapsed, lnd2atm_inst)
    use lnd2atmType, only : lnd2atm_type
    use spmdMod,     only : mpicom
    use shr_mpi_mod, only: shr_mpi_barrier
